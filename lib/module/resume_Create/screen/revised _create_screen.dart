...
class _ResumeCreateNewState extends State<ResumeCreateNew>
  ...
  void addFormWidget(int i) {
    ...
    setState(() {
      ...
      if (i == 2) _experienceListModel.experienceData.add(ExperienceModel.empty());
                    ...
                    children: [
                      StreamBuilder<PageState>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (state is DataLoadedState && index ==0) {
                          ...
                          else if(index==2 && state is ExperienceLoadedState){
                            _experienceListModel = state.data;
                            return Column(
                              children: [
                                _experienceListModel.experienceData.length>0?Column(
                                  children: _experienceListModel.experienceData.map((e) =>Experience(model: e)).toList(),
                                ):Text("Press the  +  button to add your field"),
                                Padding(
                                  padding: const EdgeInsets.all(16.0),
                                  child: CircularButton(
                                      onTap: () {
                                        if (_experienceListModel.experienceData.every((m) {
                                          if (Validator.isEmpty(m.organizationName)) {
                                            Toasty.of(context).showWarning(
                                              "Organization name is required!",
                                            );
                                            return false;
                                          }
                                          if (Validator.isEmpty(m.designation)) {
                                            Toasty.of(context).showWarning(
                                          ...
                                          setExperienceDetails(_experienceListModel);
                                        }
                                      },
                                      child: Icon(
                                        Icons.save,
                            ...
                            return Column(
                              children: [
                                _projectListModel.projectData.length>0?Column(
                                ...
                                Padding(
                                  ...
                                  child: CircularButton(
                                      onTap: () {
                                        if (_projectListModel.projectData.every((m) {
                                          if (Validator.isEmpty(m.projectName)) {
                                            Toasty.of(context).showWarning(
                            ...
                            return Column(
                              children: [
                                _referenceListModel.referenceData.length>0?Column(
                                  children: _referenceListModel.referenceData
                                ...
                                Padding(
                                  ...
                                  child: CircularButton(
                                      onTap: () {
                                        if ( _referenceListModel.referenceData.every((m) {
                                          ...
                                          setReferenceDetails(_referenceListModel);
                                        }
                                      },
                                      child: Icon(
                                        Icons.save,
  ...
  void removeItem(AcademicModel e) {
    int i  =listModel.academicData.indexOf(e);
